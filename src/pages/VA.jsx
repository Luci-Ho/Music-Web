            ...
            <div className="TopPart bg-gradient-to-r from-blue-400 to-gray-600 rounded-lg p-5">
                ...
                <div className="top2">
                    <div className="BannerPart">
                        <img src="https://www.figma.com/file/AEUVpdyAHpK7f5uEQAeace/image/755f9046844adf7d6f536a6e2d4f61847c7148ce" className="w-[268px] h-[268px]" />
                                    ...
                                    <tr key={s.id} className={"hover:bg-gray-800/30"}>
                                        ...
                                        <td className="py-2 ">
                                            <div className="flex items-center gap-3">
                                                <img src={s.img || s.cover_url} alt={s.title} className="w-12 h-12 rounded object-cover" />
                                                <div>
